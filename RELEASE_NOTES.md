...
* Добавлен список православных вендоров
* Добавлен список зарубежных вендоров
* Добавлены материалы к типам Лицензий и они были расширены
* Доработаны материалы о проекте, политике контрибьютинга и тд
* Проработан вывод карты инструментов на странице
* Реализована интерактивная карта инстурментов с pop-up функционалом и материалами из tools.json
* Доработан код под текущие линтеры проекта
* Поиск по карте вынесен в отдельный блок
